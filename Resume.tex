...
\resumeSubheading
{Stony Brook University}{Jan. 2025 - Present}
{Software Development Teaching Assistant}{Various Locations}
\resumeItemListStart
\resumeItem{Conducted weekly office hours for \textbf{162} students, focusing on best practices in software development, including modular design, maintainability, and scalability to ensure code quality and ease of debugging and extension.}
\resumeItem{Assisted in grading exams, and \textbf{strenuous testing} of student projects, providing constructive feedback to help students improve their coding skills and understanding of course concepts.}
\resumeItemListEnd

\resumeSubheading
{TD3 Innovative Gaming}{Sept. 2024 - Jan. 2025}
{Instructor}{Various Locations}
\resumeItemListStart
\resumeItem{Instructed students in basic computing skills and introductory coding concepts in Python through educational experiences on multiple video game platforms, fostering a collaborative and interactive learning environment.}
...
\resumeItem{Singlehandedly \textbf{improved} departmental efficiency by \textbf{86.35\%} through the development of custom software.}
...
\resumeItem{\textbf{Reduced} form submission time by \textbf{58\%}, significantly improving efficiency and productivity.}
\resumeItem{Designed a user-friendly front-end interface using HTML, CSS, and the Bootstrap framework, utilzing efficient \textbf{RESTful APIs} to enable seamless form submissions and data retrieval.}
\resumeItem{Developed a Flask-based backend with Python and SQLite for efficient data management, using JavaScript and \textbf{AJAX} to dynamically display database records on the website for management to view.}
\resumeItemListEnd

% \resumeProjectHeading
% {\textbf{ComplianceGenie - Data Processing} $|$ \emph{Python, pandas, Flask, React, CustomTkinter}}{Jun. 2024 -- Aug. 2024}
% \resumeItemListStart
...
% \resumeItem{Developed an intuitive front-end using CustomTkinter for a desktop app and Flask with React for a cross-platform web app, optimizing usability for non-technical staff.}
