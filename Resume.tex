...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Software Developer - Summer College Intern}{July 2024 - August 2024}
      ...
      \resumeItem{Identified problems and inefficiences in the unit, implementing software solutions to streamline workflow.}
      ...
      \resumeItem{Refactored an old R script into a standalone Python program, increasing efficiency by X\% and developing a front-end to improve user experience and usability.}
      \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
        {\textbf{CompGenie - Automatic Data Processing} $|$ \emph{Python, pandas, openpyxl, python-pptx, CustomTkinter}}{June 2024 -- August 2024}
        \resumeItemListStart
        \resumeItem{A full stack Python-based application for the NYPD to automate the generation of reports and presentations, 
        ...
        \resumeItem{Designed an intuitive front-end using CustomTkinter, prioritizing ease of use and utility for non-techincal staff.}
      ...
      \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Legion - Daemon Manager} $|$ \emph{C, Unix System Calls, Signal Handling, Process Control}}{March 2024 -- April 2024}
          \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Libraries}{: pandas, NumPy, python-pptx} \\
