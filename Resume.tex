...
{Software Development Teaching Assistant}{Stony Brook, NY}
\resumeItemListStart
...
\resumeItem{Designed a user-friendly front-end interface using HTML, CSS, and the Bootstrap framework, utilizing efficient \textbf{RESTful APIs} to enable seamless form submissions and data retrieval.}
